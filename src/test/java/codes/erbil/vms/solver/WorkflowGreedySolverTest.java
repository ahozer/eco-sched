...
@QuarkusTest
public class WorkflowGreedySolverTest {
    ...
    void solve_from_db() {
        ...
        TestSolution ts = workflowGreedySolver.solve(ti.testCase, orderedWorkflowIndexes, "O3");
    ...
    void solve_from_db2() {
        ...
        System.out.println("Objective Value:" + ts.getObjectiveValue());
